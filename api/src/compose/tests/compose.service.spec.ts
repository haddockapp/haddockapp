...
import { composeConfig, customBuildComposeConfig, fullComposeConfig } from "./mocks/compose.mock";
...
describe('ComposeService', () => {
    ...
    describe('parseServices', () => {
        it('should return parsed compose content', () => {
            const services: Service[] = service.parseServices(customBuildComposeConfig);
